...
const allTextFieldForAddCard= [
    ...
    {itemSm: 4, name: 'phone', id: 'phone', label: 'phone', autoFocus: false, fullWidth: true, type: "text", },
    {itemSm: 12, name: 'description', id: 'description', label: 'description', autoFocus: false, fullWidth: true, type: "text", },
    {itemSm: 6, name: 'email', id: 'email', label: 'email', autoFocus: false, fullWidth: true, type: "text", },
    ...
    {itemSm: 4, name: 'houseNumber', id: 'housenumber', label: 'business number', autoFocus: false, fullWidth: true, type: "text", },
    {itemSm: 4, name: 'zip', id: 'zip', label: 'zip', autoFocus: false, fullWidth: true, type: "text", },
    ]
...
export default function AddCard() {
    ...
    const schema = Joi.object({
        ...
        zip: Joi.string().min(2).max(100).required(),
    });
